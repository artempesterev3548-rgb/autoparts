export const metadata = { title: 'Политика конфиденциальности — QPart' }
    ...
    <div style={{ background: '#F0F2F5', minHeight: '100vh', padding: '40px 24px' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '0 0 20px 20px', padding: '32px 40px 40px', boxShadow: '0 4px 20px rgba(0,0,0,0.06)' }}>
          ...
          <p style={S.p}>1.1. Настоящая Политика конфиденциальности (далее — «Политика») разработана в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных (далее — «ПДн»), получаемых ООО «QPart» (далее — «Оператор») при использовании Сайта.</p>
          <p style={S.p}>1.2. Оператор — ООО «QPart», ОГРН 0000000000000, ИНН 0000000000, адрес: г. Москва.</p>

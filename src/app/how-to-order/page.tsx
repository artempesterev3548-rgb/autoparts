...
const steps = [
  {
    ...
    desc: 'Воспользуйтесь каталогом или поиском по артикулу/OEM-номеру. Если знаете VIN автомобиля — используйте раздел «Поиск по VIN»: мы подберём детали точно под вашу машину. Не нашли нужного — просто позвоните, наш менеджер поможет подобрать аналоги.',
    tips: ['Для точного подбора подготовьте VIN номер или артикул детали', 'Можно искать по бренду: MAN, Volvo, КамАЗ, Scania и др.'],
  },
  {
    num: '02',
...
const faqs = [
  {
    ...
    a: 'Да. Просто позвоните на +7 (923) 213-01-01, назовите артикул или опишите нужную деталь — менеджер оформит заказ за вас.',
  },
  {
